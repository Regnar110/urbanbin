...
const HomeAbout = () => {
    return(
        ...
        <div className='home-about-content'>
            <p>
                The company was founded on the basis of the family company GUZMET, operating on the market of producers of containers for selective waste collection for over 45 years.
